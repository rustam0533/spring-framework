...
public class CydeoApp {
    public static void main(String[] args) {
        ...
        ApplicationContext container = new AnnotationConfigApplicationContext(AppConfig.class,SecondConfig.class);
        ...
        String str2 = container.getBean("string2",String.class);
