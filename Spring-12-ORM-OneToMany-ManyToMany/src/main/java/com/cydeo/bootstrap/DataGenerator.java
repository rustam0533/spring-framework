...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        Payment payment1 = new Payment(LocalDate.of(2022,5,29),new BigDecimal(150000), Status.SUCCESS);
        PaymentDetail paymentDetail1 = new PaymentDetail(new BigDecimal(140000),new BigDecimal("10000"),LocalDate.of(2022,4,24));

        payment1.setPaymentDetail(paymentDetail1);

        Payment payment2 = new Payment(LocalDate.of(2023,2,15),new BigDecimal(110000), Status.FAIL);
        PaymentDetail paymentDetail2 = new PaymentDetail(new BigDecimal(125000),new BigDecimal("7000"),LocalDate.of(2023,7,12));
        payment2.setPaymentDetail(paymentDetail2);

        Merchant merchant1 = new Merchant("AmazonSubMerchant","M123",new BigDecimal("0.34"),new BigDecimal("3.3442432"));
